...
from ansible_collections.juniper.junos.tests.unit.compat.mock import patch, MagicMock
...
from ansible_collections.juniper.junos.plugins.modules import junos_package
