...
from ansible_collections.juniper.junos.plugins.modules import junos_facts
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.juniper.junos.plugins.module_utils.network.junos.facts.legacy.base.get_configuration')
        ...
        self.mock_exec_rpc = patch('ansible_collections.juniper.junos.plugins.module_utils.network.junos.facts.legacy.base.exec_rpc')
        ...
        self.mock_get_capabilities = patch('ansible_collections.juniper.junos.plugins.module_utils.network.junos.facts.legacy.base.get_capabilities')
