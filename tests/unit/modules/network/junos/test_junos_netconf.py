...
from ansible_collections.juniper.junos.plugins.modules import junos_netconf
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_capabilities = patch('ansible_collections.juniper.junos.plugins.module_utils.network.junos.junos.get_capabilities')
