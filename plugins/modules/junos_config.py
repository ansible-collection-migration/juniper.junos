...
from ansible_collections.juniper.junos.plugins.module_utils.network.junos.junos import get_diff, load_config, get_configuration
...
from ansible_collections.juniper.junos.plugins.module_utils.network.junos.junos import junos_argument_spec, load_configuration, tostring
